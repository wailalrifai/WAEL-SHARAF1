...
const spawnUpdate = (args, detached, callback) => {
  try {
...
exports.checkForUpdate = (updateURL, callback) => {
  return spawnUpdate(['--checkForUpdate', updateURL], false, (error, stdout) => {
    ...
    try {
      ...
      const toApply = json.releasesToApply
      const releasesFunction = typeof toApply.pop === 'function' ? toApply.pop() : undefined
      const releases = (toApply != null) ? releasesFunction : undefined
